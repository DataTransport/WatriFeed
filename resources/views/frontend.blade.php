...
<head>
    ...
    {!! app('html')->style('gtfs_frontend/css/bootstrap.css') !!}
    {!! app('html')->style('gtfs_frontend/css/font-icons/entypo/css/entypo.css') !!}
    {!! app('html')->style('gtfs_frontend/css/neon.css') !!}


    {!! app('html')->script('gtfs_frontend/js/jquery-1.11.3.min.js') !!}
...
<div class="wrap">
    ...
    @if (\Illuminate\Support\Facades\Session::has('message'))
        ...
        >{{ \Illuminate\Support\Facades\Session::get('message') }}</div>
...
<!-- Logo and Navigation -->
                        ...
                        <ul class="main-menu hidden-xs" id="main-menu">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="padding: 10px;min-width: 220px;">
                                    ...
                                    <a class="dropdown-item" target="_blank"
                                       href="{{url('/watrifeed-api')}}">
                                        WatriFeed-API
                                    </a>
                                </div>
                            </div>
                            <li class="">
                                <a href="{{ url('/watrifeed-api') }}">
                                    <span
                                ...
                                @if (Route::has('login'))
                                    <div class="top-right links">
                                        @auth
                                            ...
                                            <a class="btn btn-primary" href="{{ url('/dashboard') }}">GTFS-MANAGER </a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <section class="slider-container"
             style="background-image: url({{ asset('gtfs_frontend/images/slide-img-1-bg.png') }});">
                    ...
                    <div class="slides">
                        ...
                        <div class="slide">
                            ...
                            <div class="slide-image">
                                ...
                                <a href="#">
                                    <img height="300" src="{{ asset('gtfs_frontend/images/architecture.png') }}"
                        ...
                        <!-- Slide 2 -->
                        <div class="slide" data-bg="{{ asset('gtfs_frontend/images/slide-img-1.png') }}">

                            <div class="slide-image">

                                <a href="#">
                                    <img src="{{ asset('gtfs_frontend/images/test.png') }}" class="img-responsive"/>
                                </a>
                            </div>
                        ...
                        <div class="slide">
                            ...
                            <div class="slide-image">
                                ...
                                <a href="#">
                                    <img src="{{ asset('/images/gtfs_appmobile.png') }}" class="img-responsive"/>
                                </a>
                            </div>
                ...
                <div class="client-logos carousel slide" data-ride="carousel" data-interval="5000">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item active">
                            ...
                            <a href="#">
                                <img src="{{ asset('gtfs_frontend/images/data trans.png') }}"/>
                            </a>

                            <a href="#">
                                <img src="{{ asset('gtfs_frontend/images/billetExpress_Mali.png') }}"/>
                            </a>

                            <a href="#">
                                <img src="{{ asset('gtfs_frontend/images/ztech.png') }}"/>
                            </a>

                            <a href="#">
                                <img src="{{ asset('gtfs_frontend/images/icrisat.png') }}"/>
                            </a>
...
{!! app('html')->script('gtfs_frontend/js/gsap/TweenMax.min.js') !!}
{!! app('html')->script('gtfs_frontend/js/bootstrap.js') !!}
{!! app('html')->script('gtfs_frontend/js/joinable.js') !!}
{!! app('html')->script('gtfs_frontend/js/resizeable.js') !!}
{!! app('html')->script('gtfs_frontend/js/neon-slider.js') !!}

<!-- JavaScripts initializations and stuff -->
{!! app('html')->script('gtfs_frontend/js/neon-custom.js') !!}
