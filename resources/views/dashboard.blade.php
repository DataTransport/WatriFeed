    ...
    <div class="row" style="margin-top:65px;">
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats tile-red" style="border-bottom: 1px solid #fff;background: #003471;color: white;">
                ...
                <div class="num" data-start="0" data-end="{{$gtfs_length}}" data-postfix="" data-duration="1500" data-delay="0">0</div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats" style="border-bottom: 1px solid #fff;background: #00a651;color: white;" >
                ...
                <div class="num" data-start="0" data-end="{{$stops_length}}" data-postfix="" data-duration="1500" data-delay="600">0</div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats" style="background: #373e4a; border-bottom: 1px solid #ffffff; color: white;">
                ...
                <div class="num" data-start="0" data-end="{{$routes_length}}" data-postfix="" data-duration="1500" data-delay="1200">0</div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats " style="background: #009689; border-bottom: 1px solid #ffffff; color: white;">
                ...
                <div class="num" data-start="0" data-end="{{$stopTimes_length}}" data-postfix="" data-duration="1500" data-delay="1800">0</div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats " style="background: #732cbc; border-bottom: 1px solid #ffffff; color: white;">
                ...
                <div class="num" data-start="0" data-end="{{$trips_length}}" data-postfix="" data-duration="1500" data-delay="1800">0</div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats " style="background: #009689; border-bottom: 1px solid #ffffff; color: white;">
                ...
                <div class="num" data-start="0" data-end="{{$shapes_length}}" data-postfix="" data-duration="1500" data-delay="1800">0</div>
