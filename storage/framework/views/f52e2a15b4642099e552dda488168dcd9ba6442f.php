...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12">
        ...
        <?php echo e(session('row_current')); ?>
        ...
        <span id="gtfs" hidden><?php echo e($gtfs); ?></span>
        ...
        <div style="border: 1px solid black;" class="panel panel-primary" data-collapsed="0">
            ...
            <div style="border-bottom: 1px solid #000000;" class="panel-heading">
                ...
                <div class="panel-options">
                    ...
                    <a style="font-size: 13px;" id="setting"  data-gtfs="<?php echo e($gtfs->name); ?>" href="" data-rel="reload" >
                        Settings
                    </a>
                </div>
            </div>
            <div class="panel-body">
                <table class="table table-bordered datatable col-sm-12" id="table-4">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->agencies()->count()); ?> </td>
                        <td>
                            <a href="/agency?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->stops()->count()); ?> </td>
                        <td>
                            <a href="/stop?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->routes()->count()); ?> </td>
                        <td>
                            <a href="/route?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->trips()->count()); ?> </td>
                        <td>
                            <a href="/trip?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->stoptimes()->count()); ?> </td>
                        <td>
                            <a href="/stoptime?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                            ...
                            <a href="<?php echo e(route('stoptimes-export')); ?>" class="btn btn-success btn-sm btn-icon icon-left">
                                <i class="entypo-download"></i>
                                Export
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->shapes()->count()); ?> </td>
                        <td>
                            <a href="/shape?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                            ...
                            <a href="<?php echo e(route('shapes-export')); ?>" class="btn btn-success btn-sm btn-icon icon-left">
                                <i class="entypo-download"></i>
                                Export
                            </a>
                        </td>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->frequencies()->count()); ?> </td>
                        <td>
                            <a href="/frequency?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->calendars()->count()); ?> </td>
                        <td>
                            <a href="/calendar?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->calendar_dates()->count()); ?> </td>
                        <td>
                            <a href="/calendardate?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->fare_attributes()->count()); ?> </td>
                        <td>
                            <a href="/fareattribute?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->fare_rules()->count()); ?> </td>
                        <td>
                            <a href="/farerule?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        <td>pathways.txt</td>
                        <td class="td_total"> <?php echo e($gtfs->pathways()->count()); ?> </td>
                        <td>
                            <a href="/pathway?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="td_total"> <?php echo e($gtfs->transfers()->count()); ?> </td>
                        <td>
                            <a href="/transfer?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
                    ...
                    <tr class="odd gradeX">
                        <td>levels.txt</td>
                        <td class="td_total" > <?php echo e($gtfs->levels()->count()); ?> </td>
                        <td>
                            <a href="/level?t=<?php echo csrf_token(); ?>&g=<?php echo e($gtfs->id); ?>&_=<?php echo e($gtfs->password); ?>"
                               class="edit_gtfs btn btn-info btn-sm btn-icon icon-left">
                                <i class="entypo-pencil"></i>
                                Edit
                            </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" action="<?php echo e(route('stops-import')); ?>" method="post"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" action="<?php echo e(route('stoptimes-generate')); ?>" method="post"
...
<?php $__env->startSection('scripts_page'); ?>
    ...
    <script>
        ...
        $('#setting').on('click', function () {
            ...
            post('/gtfs/setting', {gtfs: $(this).data('gtfs'), "_token": "<?php echo e(csrf_token()); ?>"})
        });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel/watrifeed-php-v1/resources/views/gtfs/edit.blade.php ENDPATH**/ ?>